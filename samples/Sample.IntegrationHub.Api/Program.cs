...
using Sample.IntegrationHub.Api;
...
// EnsureCreated en vez de migraciones (mismo criterio que Sample.Notifications.Api): este es un proyecto
// de referencia/demo de la plataforma, no un consumidor productivo.
using (var scope = app.Services.CreateScope())
{
    await scope.ServiceProvider.GetRequiredService<IntegrationHubDbContext>().Database.EnsureCreatedAsync();
